...
namespace gradido::data {
  namespace compact {
    ...
    ConfirmedGradidoTxCold* ConfirmedGradidoTxCold::fromGrdw(
      ...
      auto txCold = fromGrdwConfirmedTransaction(tx);
      txCold->fillFromGrdwTransactionBody(body);
      return txCold;
    }

    ConfirmedGradidoTxCold* ConfirmedGradidoTxCold::fromGrdwConfirmedTransaction(const grdw_confirmed_transaction* tx)
    {
    ...
    void ConfirmedGradidoTxCold::fillFromGrdwTransactionBody(const grdw_transaction_body* body)
    {
