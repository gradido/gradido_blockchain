...
namespace gradido::data::compact {
  RegisterAddressTx RegisterAddressTx::fromGrdw(const grdw_register_address* grdw_register_address, uint32_t blockchainCommunityIdIndex)
  {
    ...
    registerAddress.addressType = grdw_register_address->address_type;
    ...
    registerAddress.userPublicKeyIndex = PublicKeyIndex::fromPublicKey(blockchainCommunityIdIndex, grdw_register_address->user_pubkey).publicKeyIndex;
    registerAddress.accountPublicKeyIndex = PublicKeyIndex::fromPublicKey(blockchainCommunityIdIndex, grdw_register_address->account_pubkey).publicKeyIndex;
