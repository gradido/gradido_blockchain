...
namespace gradido {
	...
	using data::ConfirmedTransaction, data::GradidoRedeemDeferredTransfer;
	namespace interaction {
		namespace validate {
			...
			) : mRedeemDeferredTransfer(redeemDeferredTransfer), mCrossGroupType(GRDT_CROSS_GROUP_LOCAL)
			{
